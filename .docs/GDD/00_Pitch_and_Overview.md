...
> **Note:** For MVP testing scope and project phases, see `09_MVP_And_Roadmap.md`. This document and the rest of the GDD describe the **complete product vision**; `09` alone describes what ships first.

> **Naming:** `11_References_and_Appendix.md` holds the canonical vocabulary for the whole GDD. Where a term there says _"Formerly X,"_ X is retired.
...
| **Fair Competition** | Simultaneous real-time play on a surface whose two starting positions are interchangeable removes first-mover advantage outright; the Komi system stands ready to compensate the planned asymmetric maps. |
...
The hexagonal planetary surface is the whole battlefield. Victory depends on **positioning**, not brute force. Every Clone expands territory; every Jump repositions power. The interplay between specimen abilities and planetary geography creates emergent tactical depth that rewards planning over reflexes alone.
...
Specimen collection, DNA Strand-based Enhancements, and a **10-Star-System** progression ladder create a long discovery arc. Enhancement is designed to deepen a specimen without inflating it — what exactly a level changes is an open design item tracked in `02_Mathematics_and_Balancing.md`.
...
Mathematics-driven balance via the $P_v \propto E^2$ power-cost formula, symmetric launch geometry, and a calibrated Komi lever for future asymmetric maps together ensure competitive integrity. Blind Discovery further strips away progression advantages for pure-skill tournaments.
...
flowchart LR
    ...
    C --> D["Enhance Specimens<br/>DNA Strands + Stardust"]
    D --> E["Build Kits<br/>Optimize 8-Card Kit"]
    E --> A
...
|  4   | **Enhance Specimens**    | Power fantasy — progress feels meaningful without breaking competitive parity.   |
|  5   | **Build Kits**           | Self-expression — experiment with 8-card Kits and discover synergies.            |
...
| **ARPDAU** _(Optimistic scenario)_ | USD 0.08 - 0.15 | USD 0.05 - 0.12               |
...
| 02  | `02_Mathematics_and_Balancing.md`              | Power-cost formula, progression curves, Komi, Star System ladder, matchmaking.           |
| 03  | `03_Specimens_Protocols_and_Factions.md`       | Full Specimen roster, Protocols, synergy matrix, Kit archetypes, card data schema.       |
| 04  | `04_Economy_and_Monetization.md`               | Dual currency (Stardust/Nova Cores), capsule cycle, Galaxy Pass, pricing strategy.       |
| 05  | `05_Meta_Game_Retention_and_LiveOps.md`        | Crews, Galactic Phenomena, Expedition Cycles, daily/weekly Research Contracts.           |
