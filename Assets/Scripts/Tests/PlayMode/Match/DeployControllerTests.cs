...
namespace GooGalaxy.Tests.PlayMode.Match
{
    ...
    public class DeployControllerTests
    {
        ...
        public void TryPlayCard_MatchNotInStandardPhase_ReturnsMatchNotInPlayAndLeavesHandAndEnergyUntouched(MatchPhase phase)
        {
            // GIVEN
        ...
        {
            return BuildDeployController(card, _ledger, _matchController);
        }

        private DeployController BuildDeployController(CardDataSO card, IEnergyLedger ledger)
        {
            return BuildDeployController(card, ledger, _matchController);
        }

        private DeployController BuildDeployController(CardDataSO card, IEnergyLedger ledger, MatchController matchController)
        {
