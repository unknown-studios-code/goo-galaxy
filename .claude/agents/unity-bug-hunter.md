...
Follow the order in `.claude/rules/unity-debugging.md`. A fix you write is code like any other, so it is bound by the same conventions:
...
Common Goo Galaxy failure classes:
