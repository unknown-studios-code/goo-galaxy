...
| **Specimens, Protocols & Factions**      | The full card roster and every stat block, counter matrix, Kit archetypes, landing-impact targeting, the `CardDataSO` authored schema, impact types still to come  | `https://app.notion.com/3b856d55129b81d99ea9fd13ff4187e4` |
...
| **Operations, Security & Legal**         | GDPR/LGPD/CCPA, COPPA and the age gate, loot box disclosure and regional variants, anti-cheat, analytics events, soft launch, incident response                    | `https://app.notion.com/3b856d55129b81e68975e0844955aedf` |
| **References & Appendix**                | The canonical glossary — the naming authority for the whole GDD — plus key formulas and quick-reference tables for roster, Star Systems, and Energy                | `https://app.notion.com/3b856d55129b8116995ee6a66fa7e300` |
...
**A page ID that fails to resolve is not a reason to guess.** Re-resolve it with Notion search against the Documentation wiki (`https://app.notion.com/p/31b56d55129b801aa007d27114249b81`) and report the new URL so this table can be corrected. A recreated page gets a new ID.
