...
agents: [Unity Netcode Engineer, Unity Perf Auditor]
---
...
Follow the order in `.github/instructions/unity-debugging.instructions.md`. Common Goo Galaxy failure classes:
...
7. Verify with the errors tool and hand the user a concrete way to confirm the fix.
