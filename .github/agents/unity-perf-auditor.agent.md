...
- DO NOT run builds, profilers, or the editor. You do static analysis of source and configuration.
...
- DO NOT propose fixes that violate the project's architecture rules — check `.github/instructions/` before suggesting a pattern change.
...
Authoritative rules: `.github/instructions/unity-performance-optimization.instructions.md` and `unity-project-configuration.instructions.md`. Cite them per finding.
