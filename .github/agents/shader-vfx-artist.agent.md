...
- DO NOT hardcode colors that belong to the art direction palette — expose them as material properties and cite `.docs/GDD/06`.
...
- Art direction and UX constraints: `.docs/GDD/06_Art_Direction_and_UX.md`. Read it before proposing a look.
- Quality tiers and shader stripping rules: `.github/instructions/unity-project-configuration.instructions.md`.
- Any C# that drives an effect follows the standard rulesets in `.github/instructions/` — including no allocation or `Camera.main` in update loops.
